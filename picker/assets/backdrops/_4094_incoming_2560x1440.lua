---@module "picker.assets.backdrops._4094_incoming_2560x1440"
---@author sravioli
---@license GNU-GPLv3
...
M.get = function()
  return { id = "_4094_incoming_2560x1440", label = "04094 Incoming 2560x1440" }
end

M.activate = function(Config, opts)
  local backdrop = require "utils.backdrop"
  -- Find the index of this image in the backdrop.images array
  local target_filename = "04094_incoming_2560x1440.jpg"
