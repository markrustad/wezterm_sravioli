---@module "picker.assets.backdrops.pxl_20210515_175658280_crop"
---@author sravioli
---@license GNU-GPLv3
...
M.get = function()
  return { id = "pxl_20210515_175658280_crop", label = "Pxl 20210515 175658280 Crop" }
end

M.activate = function(Config, opts)
  local backdrop = require "utils.backdrop"
  -- Find the index of this image in the backdrop.images array
  local target_filename = "PXL_20210515_175658280_crop.png"
