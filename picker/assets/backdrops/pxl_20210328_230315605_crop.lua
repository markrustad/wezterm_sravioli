---@module "picker.assets.backdrops.pxl_20210328_230315605_crop"
---@author sravioli
---@license GNU-GPLv3
...
M.get = function()
  return { id = "pxl_20210328_230315605_crop", label = "Pxl 20210328 230315605 Crop" }
end

M.activate = function(Config, opts)
  local backdrop = require "utils.backdrop"
  -- Find the index of this image in the backdrop.images array
  local target_filename = "PXL_20210328_230315605_crop.png"
