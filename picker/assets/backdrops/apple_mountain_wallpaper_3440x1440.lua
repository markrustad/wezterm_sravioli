---@module "picker.assets.backdrops.apple_mountain_wallpaper_3440x1440"
---@author sravioli
---@license GNU-GPLv3
...
M.get = function()
  return {
    id = "apple_mountain_wallpaper_3440x1440",
    label = "Apple Mountain Wallpaper 3440x1440",
  }
end
...
M.activate = function(Config, opts)
  ...
  local target_filename = "apple_mountain-wallpaper-3440x1440.jpg"
