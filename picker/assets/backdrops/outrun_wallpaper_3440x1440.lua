---@module "picker.assets.backdrops.outrun_wallpaper_3440x1440"
---@author sravioli
---@license GNU-GPLv3
...
M.get = function()
  return { id = "outrun_wallpaper_3440x1440", label = "Outrun Wallpaper 3440x1440" }
end

M.activate = function(Config, opts)
  local backdrop = require "utils.backdrop"
  -- Find the index of this image in the backdrop.images array
  local target_filename = "outrun-wallpaper-3440x1440.jpg"
